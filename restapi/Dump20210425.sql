...
INSERT INTO `kortti` VALUES (1,'$2a$10$P1rHLmGXJ7KE19HC2YaHHeX./vmKjVPAU9sfvk4EeaWNkMxHZ.9XG','112233',2,'-06000DE540',0),(2,'$2a$10$kLH1cqvKkZo.qXs/u/U6L.Z256gS7dKr72/xcqe6Z1pWhmZwfVq5e','112244',3,'-06000DE53B',0),(3,'$2a$10$RZC5U3mf5gDNg9r5CXwbNu6mog.gJVzIaypV8jaBbHocvc..hzETi','112255',4,'-06000E1B4D',0);
...
INSERT INTO `tili` VALUES (1,NULL,NULL),(2,'12345',183574),(3,'12346',748),(4,'22222',6705),(5,'22221',2700),(6,'22223',44300);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `siirto`(in id int, in id2 int, in summa double)
begin
start transaction;
...
commit;
if(summa>0) then
insert into tapahtuma(Tapahtuma_tyyppi, Rahan_maara, paivays) values('pano', -summa, now());
else
insert into tapahtuma(Tapahtuma_tyyppi, Rahan_maara, paivays) values('otto', -summa, now());
end if;
else
rollback;
end if;
...
-- Dump completed on 2021-04-25 16:00:50
